...
namespace Com_Saude.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(Com_SaudeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEspecialidade,Descricao")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEspecialidade,Descricao")] Especialidade especialidade)
        {
